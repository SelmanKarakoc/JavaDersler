...
public class C02_StringManipulation {
    public static void main(String[] args) {
        //verilen bir cumlede istenen kelimenin kaç kere
        //geçtiğini bulup yazdıran method

        String cumle="Java basladi ve bitti. Java meger ne guzelmis. Ne phyton ne C, Java en iyisi";
        String istenenKelime="bit";
    ...
    private static void kullanimSayisiBul3(String cumle, String istenenKelime) {
        ...
        if (kullanimSayisi==0) System.out.println("Cumlede aranan kelime yok");
        else System.out.println("Kelime cumlede "+ kullanimSayisi+" adet kullanılmıştır");

    }

    private static void kullanimSayisiBul2(String cumle, String istenenKelime) {
        //forloop ve substirng ile
        int kullanimSayisi=0;
